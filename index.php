...
<summary>Categorías</summary>
  ...
  <form name="categorias" method="GET" action="index.php" id="categorias">
    ...
    <button type="submit" name="cat" value="FOT" class="btn btn-link btn-sm">Foto y Video</button>
...
?>
  ...
  <footer class="px-3 pt-5">
      <div class="border-top text-center">
        ...
        <p class="fs-6">Un archivo de "los planitos" publicados en la <a class="link-opacity-50-hover ms-1 link-dark" title="Revista Lúpin en AHiRA" href="https://ahira.com.ar/revistas/lupin/" target="_blank">Revista Lúpin</a></p>
        <p class="fs-6">Aeromodelismo, scoutismo y camping, electrónica, astronomía, dibujo y mucho mas...</p>
